import{_ as i}from"./margin-ffb75277.js";import{_ as n,p as a,q as t,Y as d,s as e}from"./framework-aa5c4115.js";const l={},s=d(`<h2 id="八、边距属性" tabindex="-1"><a class="header-anchor" href="#八、边距属性" aria-hidden="true">#</a> 八、边距属性</h2><p>CSS的边距属性包括内边距和外边距。</p><h3 id="_1-内边距" tabindex="-1"><a class="header-anchor" href="#_1-内边距" aria-hidden="true">#</a> 1.内边距</h3><p>内边距指的是元素内容与边框之间的距离。<br> 在CSS中我们通过padding属性来设置内边距, 相关设置方法如下:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>padding: 上下左右方向边距相同
padding-top: 上边距
padding-bottom: 下边距
padding-right: 右边距
padding-left: 左边距
