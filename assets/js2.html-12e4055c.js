import{_ as e,p as n,q as i,Y as d}from"./framework-aa5c4115.js";const a="/js/js2-1.png",s="/js/js2-2.png",t={},l=d(`<h2 id="对象" tabindex="-1"><a class="header-anchor" href="#对象" aria-hidden="true">#</a> 对象</h2><p>对象属于一种复合数据类型, 在对象中可以保存多种数据类型的属性。<br> 对象的分类:</p><ol><li>内建对象: 由 ES 标准中定义的对象, 在任何 ES 实现中都能使用。</li><li>宿主对象: 由 JS 运行环境提供的对象, 如 DOM BOM</li><li>自定义对象: 由开发人员自己创建的对象</li></ol><h3 id="创建对象" tabindex="-1"><a class="header-anchor" href="#创建对象" aria-hidden="true">#</a> 创建对象</h3><p>使用 <code>new</code> 关键字调用的函数, 是构造函数constructor<br> 构造函数是专门用来创建对象的函数</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>let girlfriend = new Object();
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由上面两个例子可以看出:<br> 基本数据类型的值直接存储在栈内存中, 值与值之间是相互独立的, 一个值的改变不会影响另一个值。<br> 对象是保存在堆内存中, 每创建一个对象就会在堆内存中开辟出一个新的空间, 变量保存的是对象的内存地址(对象的引用), 如果两个变量保存的是同一个对象引用, 当通过一个变量修改属性时, 另一个也会受到影响。 <img src="`+a+'" alt=""></p><p><img src="'+s+`" alt=""></p><h2 id="对象字面量" tabindex="-1"><a class="header-anchor" href="#对象字面量" aria-hidden="true">#</a> 对象字面量</h2><p>对象字面量是创建对象的另一种方式</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>let girlfriend = {
  name: &quot;xiaohong&quot;,
  age: 18
};
