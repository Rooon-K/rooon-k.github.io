import{_ as n,a as e,b as l,c as d,d as i,e as s}from"./float6-bb5e737d.js";import{_ as v,p as t,q as a,Y as r}from"./framework-aa5c4115.js";const c={},b=r(`<h2 id="十三、float-浮动" tabindex="-1"><a class="header-anchor" href="#十三、float-浮动" aria-hidden="true">#</a> 十三、float 浮动</h2><p>在 CSS 中, 通过 float 属性来定义浮动, 元素的浮动是指设置了移动属性的元素会脱离标注文档流的控制, 移动到其父元素中指定位置的过程。<br> 其语法格式为:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>选择器 {
  float: 属性值;
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>float 的常用属性值:</p><table><thead><tr><th>属性值</th><th>描述</th></tr></thead><tbody><tr><td>left</td><td>元素向左浮动</td></tr><tr><td>right</td><td>元素向右浮动</td></tr><tr><td>node</td><td>元素不浮动( 默认值 )</td></tr></tbody></table><p>案例:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!doctype html&gt;
&lt;html&gt;
