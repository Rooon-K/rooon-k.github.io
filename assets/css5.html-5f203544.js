import{_ as i,a as n,b as e,c as l,d}from"./position4-6eda2d09.js";import{_ as s,p as t,q as v,Y as a}from"./framework-aa5c4115.js";const c={},r=a(`<h2 id="十六、元素的定位" tabindex="-1"><a class="header-anchor" href="#十六、元素的定位" aria-hidden="true">#</a> 十六、元素的定位</h2><p>浮动布局虽然灵活, 但是无法对元素的位置进行精确控制。在 CSS 中, 通过定位属性可以实现元素的精确定位。</p><h3 id="元素的定位属性" tabindex="-1"><a class="header-anchor" href="#元素的定位属性" aria-hidden="true">#</a> 元素的定位属性</h3><ol><li>定位模式</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>选择器 {
  position: 属性值;
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>常用属性值:</p><table><thead><tr><th>值</th><th>描述</th></tr></thead><tbody><tr><td>static</td><td>静态定位(默认值)</td></tr><tr><td>relative</td><td>相对定位, 相对于其原文档流的位置进行定位</td></tr><tr><td>absolute</td><td>绝对定位, 相对于其上一个已经定位的父元素进行定位</td></tr><tr><td>fixed</td><td>固定定位, 相对于浏览器窗口进行定位</td></tr></tbody></table><ol start="2"><li>边偏移 在 CSS 中通过边偏移属性 top、bottom、left、right 来精确定义元素的位置。<br> 边偏移设置方式: | 属性 | 描述 | |------|-----| | top | 顶端偏移量, 定义元素相对于其父元素上边线的距离 | | bottom | 底部偏移量, 定义元素相对于其父元素下边线的距离 | | left | 左侧偏移量, 定义元素相对于其父元素左边线的距离 | | right | 右偏移量, 定义元素相对于其父元素右边线的距离 |</li></ol><p>示例:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>position: relative; /* 相对定位 */
...
&lt;/html&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+d+'" alt=""></p>',36),u=[r];function b(m,o){return t(),v("div",null,u)}const p=s(c,[["render",b],["__file","css5.html.vue"]]);export{p as default};
